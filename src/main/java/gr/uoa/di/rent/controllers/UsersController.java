...
public class UsersController {
    ...
    public ResponseEntity<?> updateUserInfo(@Valid @PathVariable(value = "userId") Long userId,
            @Valid @RequestBody UserUpdateRequest userUpdateRequest, @Valid @CurrentUser UserDetailsImpl currentUser) {
    ...
    private void checkReservedData(Long userId, UserDetailsImpl currentUser, User user) throws UserExistsException {
