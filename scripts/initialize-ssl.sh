...
keytool -export -keystore src/main/resources/keystore.p12 -alias tomcat -file rentCertificate.crt -storepass rent_project
keytool -importcert -file rentCertificate.crt -storepass rent_project -keystore %JRE_HOME%\lib\security\cacerts
